...
namespace Sol_SEO.Helper
{
    public static class SeoHelper
    {
        public static async Task<string> GetFriendlyTitle(string title, bool remapToAscii = false, int maxlength = 80)
        {
            ...
            return await Task.Run(async () => {
                ...
                for (int i = 0; i < length; ++i)
                {
                    ...
                    else if (c >= 128)
                    {
                        ...
                        if (remapToAscii)
                        {
                            stringBuilder.Append(await RemapInternationalCharToAsciiAsync(c));
                        }
                        else
                        {
                            stringBuilder.Append(c);
        ...
        private async static Task<string> RemapInternationalCharToAsciiAsync(char character)
        {
